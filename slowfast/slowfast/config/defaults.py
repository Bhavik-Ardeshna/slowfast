...
_C.TEST.SAVE_RESULTS_PATH = "result"
...
_C.DATA.PATH_TO_DATA_DIR = "../tmpdata"

# The separator used between path and label.
_C.DATA.PATH_LABEL_SEPARATOR = " "

# Video path prefix if any.
_C.DATA.PATH_PREFIX = "../tmpdata"
...
_C.DATA.TRAIN_JITTER_SCALES = [100, 100]
...
_C.DATA.TRAIN_CROP_SIZE = 80

# The spatial crop size for testing.
_C.DATA.TEST_CROP_SIZE = 80
...
# Path to a json file providing class_name - id mapping
# in the format {"class_name1": id1, "class_name2": id2, ...}.
_C.DEMO.LABEL_FILE_PATH = "kinetics_classnames.json"
