...
class VideoManager:
    ...
    def __init__(self, cfg):
        ...
        self.n_fps = int(self.cap.get(cv2.CAP_PROP_FPS))
        # self.n_seconds = round(self.n_frames / self.n_fps)
        # self.n_video_time = datetime.timedelta(seconds=self.n_seconds)
        self.n_seconds = [1]
        self.n_video_time = [1]
    ...
    def __next__(self):
        ...
        n_sec = int(round(len(frames) / self.n_fps))
        n_vt = datetime.timedelta(seconds=n_sec)+ datetime.timedelta(seconds=int(self.n_seconds[-1]))
        self.n_seconds.append(n_sec+self.n_seconds[-1])
        self.n_video_time.append(n_vt)
        # print("---------------------------------")
        # print(self.n_seconds)
        # print(self.n_video_time)
        # print(n_sec)
        # print(n_vt)
        # print("---------------------------------")
